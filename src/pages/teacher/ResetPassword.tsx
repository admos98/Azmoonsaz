    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-violet-50 flex items-center justify-center p-4">
        <div className="w-full max-w-md text-center">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-indigo-100 rounded-3xl mb-4 animate-pulse">
            <GraduationCap className="w-10 h-10 text-indigo-600" />
          </div>
          <p className="text-sm text-slate-500">در حال بررسی لینک...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-violet-50 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 p-8 text-center space-y-4">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-emerald-100 rounded-full">
              <CheckCircle2 className="w-8 h-8 text-emerald-600" />
            </div>
            <h2 className="text-lg font-bold text-slate-800">رمز عبور با موفقیت تغییر کرد</h2>
            <p className="text-sm text-slate-500">حالا می‌توانید با رمز جدید وارد شوید.</p>
            <button
              onClick={onDone}
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-sm py-3 rounded-xl transition-colors cursor-pointer"
            >
              ورود
            </button>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-violet-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">آزمون‌ساز</h1>
          <p className="text-sm text-slate-500 mt-1">تغییر رمز عبور</p>
        </div>
