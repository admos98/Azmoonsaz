                  ...
                  {activeQuestion.imageUrl && (
                    <div className="my-3 text-right" id="question-image-frame">
                      ...
                      <img
                        ...
                        className="rounded-xl border border-[var(--color-glass-light-stroke)] max-h-56 object-contain w-full max-w-lg shadow-sm hover:scale-[1.01] transition-transform"
                      />
                    </div>
                  )}
                            ...
                            >
                              {hasImg && opt.imageUrl && (
                                <img
                                  ...
                                  alt={opt.text}
                                  referrerPolicy="no-referrer"
                                  className="w-full h-32 object-cover rounded-xl border border-[var(--color-glass-light-stroke)]"
                                />
                              )}
